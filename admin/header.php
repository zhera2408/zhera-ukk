    ...
    <div class="wrapper">
        <nav class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="anggota.php" class="<?php echo(basename($_SERVER['PHP_SELF']) == 'anggota.php' || basename($_SERVER['PHP_SELF']) == 'anggota_tambah.php' || basename($_SERVER['PHP_SELF']) == 'anggota_edit.php') ? 'active' : ''; ?>"><i class="fas fa-users"></i> Data User</a></li>
                <li><a href="buku.php" class="<?php echo(basename($_SERVER['PHP_SELF']) == 'buku.php' || basename($_SERVER['PHP_SELF']) == 'buku_tambah.php' || basename($_SERVER['PHP_SELF']) == 'buku_edit.php') ? 'active' : ''; ?>"><i class="fas fa-book"></i> Data Buku</a></li>
                <li><a href="peminjaman.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'peminjaman.php' ? 'active' : ''; ?>"><i class="fas fa-clipboard-list"></i> Peminjaman</a></li>
